...
def Setup():
	...
	print(f'''{Fore.RESET}
		   {Fore.GREEN}    ____            __{Fore.RESET}{Fore.CYAN}   ____                 {Fore.RESET}{Fore.RED}     ____        _     __{Fore.RESET}
		   {Fore.GREEN}   / __ \____ _____/ /{Fore.RESET}{Fore.CYAN}  / __ \____ __   _____ {Fore.RESET}{Fore.RED}    / __ \____ _(_)___/ /{Fore.RESET}
		   {Fore.GREEN}  / /_/ / __ `/ __  / {Fore.RESET}{Fore.CYAN} / /_/ / __ `/ | / / _ \{Fore.RESET}{Fore.RED}   / /_/ / __ `/ / __  / {Fore.RESET}
		   {Fore.GREEN} / _, _/ /_/ / /_/ /  {Fore.RESET}{Fore.CYAN}/ _, _/ /_/ /| |/ /  __/{Fore.RESET}{Fore.RED}  / _, _/ /_/ / / /_/ /  {Fore.RESET}
		   {Fore.GREEN}/_/ |_|\__,_/\__,_/  {Fore.RESET}{Fore.CYAN}/_/ |_|\__,_/ |___/\___/ {Fore.RESET}{Fore.RED} /_/ |_|\__,_/_/\__,_/   {Fore.RESET}


				   {Fore.YELLOW}RadRaveRaid {INIT.__version__} {Fore.RESET}| Because fuck you
				   {Fore.YELLOW}Type "help" for a list of commands
				   {Fore.GREEN}{counttokens}{Fore.RESET}{Fore.YELLOW} tokens loaded!
				   {Fore.GREEN}{countproxies}{Fore.RESET}{Fore.YELLOW} proxies loaded!
				   {Fore.YELLOW}Created by {Fore.RESET}ria
				   {Fore.YELLOW}https://github.com/{Fore.RESET}riaaaaaaaa
''' + Fore.RESET)

def Help():
	print(f'''{Fore.RESET}{Fore.RED}		-- Commands are seperated by commas --{Fore.RESET}
{Fore.YELLOW}join,invite | {Fore.RESET}Joins all your tokens to the server using the specified invite.
{Fore.YELLOW}spam,channelid,amount,message | {Fore.RESET}Spams the given channel any amount of times. Tokens must already be in the server.
{Fore.YELLOW}friend,username#discrimanator | {Fore.RESET}Makes all your tokens send a friend request to your target.
{Fore.YELLOW}dm,userid,amount,message | {Fore.RESET}Makes all your tokens DM the given ID.
{Fore.YELLOW}check-tokens | {Fore.RESET}Checks all of your tokens to see if they are valid.
{Fore.YELLOW}scrape-proxies | {Fore.RESET}Scrapes HTTP proxies from proxyscrape.com and writes them to proxies.txt.
{Fore.YELLOW}reset | {Fore.RESET}Resets the console.
''' + Fore.RESET)
	Start()
...
def Start():
	...
	if command[0] == 'help':
		...
		amount = command[3]
		message = command[4]
		Raid(invite,channel,amount,message)
	elif command[0] == 'spam':
		channel = command[1]
		amount = command[2]
		message = command[3]
